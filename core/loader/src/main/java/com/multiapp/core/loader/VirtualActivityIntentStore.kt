...
/**
 * Process-local store for original guest Activity intents.
 *
 * Proxy Activity launches cross AMS with only stable scalar extras. Keeping the
 * full guest Intent here avoids parceling large Bundles or app-defined
 * Parcelable objects through the host proxy Intent.
 */
object VirtualActivityIntentStore {

...
class StubServiceV8 : StubService()
class StubServiceV9 : StubService()
class StubServiceV10 : StubService()
class StubServiceV11 : StubService()
class StubServiceV12 : StubService()
class StubServiceV13 : StubService()
class StubServiceV14 : StubService()
class StubServiceV15 : StubService()
class StubServiceV16 : StubService()
class StubServiceV17 : StubService()
class StubServiceV18 : StubService()
class StubServiceV19 : StubService()
class StubServiceV20 : StubService()
class StubServiceV21 : StubService()
class StubServiceV22 : StubService()
class StubServiceV23 : StubService()
